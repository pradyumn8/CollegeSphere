    ...
    return (
        <motion.div
            ...
            <div className="contact-col">
                ...
                <ul>
                    <li><img src={mail_icon} alt="" />upavan.e.library@gmail.com</li>
                    <li><img src={phone_icon} alt="" />+91 8009013529   </li>
                    <li><img src={location_icon} alt="" />222165 Janghai, Station Road <br />Jaunpur UP</li>
                </ul>
            </div>
            <div className="contact-col">
